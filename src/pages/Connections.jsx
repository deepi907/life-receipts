      ...
      try {
        ...
        const cleanConnections = (
          ...
          return {
            ...
            counts: {
              spotify: safeNumber(counts.spotify),
              household: safeNumber(counts.household),
              india: safeNumber(counts.india),
          ...
          <div className="connection-stack">
            ...
            {connections.map(
              (connection, index) => {
                ...
                const music =
                  safeNumber(counts.spotify);

                const household =
                  safeNumber(counts.household);

                const purchases =
                  safeNumber(counts.india);

                // IMPORTANT:
                // Use the total already generated
                // by patterns.js.
                const total =
